#ifndef SINGLEPASS_DPX_KERNEL_CUH
#define SINGLEPASS_DPX_KERNEL_CUH

#error "do not include singlepass_dpx_kernel.cuh yet"
...
void call_NW_local_affine_single_pass_s16_DPX_new(
    ...
    NW_local_affine_single_pass_s16_DPX_new<group_size, numRegs><<<grid, blocksize, 0, stream>>>(
        devChars,
        devAlignmentScores,
        devOffsets,
        devLengths,
