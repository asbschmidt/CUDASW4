                        ...
                        auto runAlignmentKernels = [&](auto& d_scores, ReferenceIdT* d_overflow_positions, int* d_overflow_number){
                            ...
                            for(int lp = plan.h_partitionIds.size() - 1; lp >= 0; lp--){
                                ...
                                if(kernelTypeConfig.singlePassType == KernelType::Half2){
                                    ...
                                    if (partId == 2){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<3>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 3){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<3>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 6){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<5>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 7){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<5>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 10){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<7>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    if (partId == 11){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<7>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 14){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<9>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 16){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<11>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 18){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<13>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
                                    ...
                                    if (partId == 20){ call_NW_local_affine_read4_float_query_Protein_single_pass_new<15>(blosumType, inputChars, d_scores, inputOffsets, inputLengths, d_selectedPositions, numSeq, d_query, currentQueryLength, gop, gex, nextWorkStreamNoTemp()); CUERR }
